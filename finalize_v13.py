...
output_path = 'Wayfair_TV_Stands_V13_Final_Success.xlsx'
...
for i in range(1, 7):
    products_data.append({
        "sku": f"CASA-TV-V13-{400+i}",
        "name": f"Elite Heritage TV Console V13-{400+i}",
        "upc": f"8401341004{20+i}",
        "price": 625 + (i*65),
        "img": "https://casadesignfurniture.com/wp-content/uploads/2023/12/Group-4-1.png",
        "w": 66, "d": 16, "h": 22, "weight": 86
    })
...
for i, p in enumerate(products_data[:15]):
    ...
    # Final sweep for Required cells
