...
source_path = '/root/.openclaw/media/inbound/file_12---4ee7cb1f-7aeb-4be1-a9cf-baa7d72bb308.xlsx'
output_path = 'Wayfair_TV_Stands_V12_Ready.xlsx'
...
for i in range(1, 7):
    products_data.append({
        "sku": f"CASA-TV-X12-{300+i}",
        "name": f"Elite V12 Series TV Console {300+i}",
        "upc": f"8401341003{10+i}",
        "price": 550 + (i*60),
