...
source_path = '/root/.openclaw/media/inbound/file_11---434509f8-e633-4f6a-ad05-3d049fcd621b.xlsx'
output_path = 'Wayfair_TV_Stands_V11_Final.xlsx'
...
for i in range(1, 7):
    products_data.append({
        "sku": f"CASA-TV-MOD-{200+i}",
        "name": f"Modern Luxury TV Suite {200+i}",
        "upc": f"8401341002{10+i}",
        "price": 580 + (i*55),
        "img": "https://casadesignfurniture.com/wp-content/uploads/2023/12/Group-4-1.png",
        "w": 68, "d": 16, "h": 21, "weight": 84
    })
...
for i, p in enumerate(products_data[:15]):
    ...
    # Final cleanup for required cells
