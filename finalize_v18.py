...
source_path = '/root/.openclaw/media/inbound/file_18---f5c15db9-0725-48e2-8e5b-2b88951bfa98.xlsx'
output_path = 'Wayfair_TV_Stands_Final_V18_DeepFill.xlsx'
...
# Product Database (Same data as V14/V13 for consistency)
products_data = [
...
# Populate extra items up to 15
for i in range(1, 7):
    products_data.append({
        "sku": f"CASA-TV-V18-{500+i}",
        "name": f"Elite Modern TV Console V18-{500+i}",
        "upc": f"8401341005{30+i}",
        "price": 650 + (i*70),
        "img": "https://casadesignfurniture.com/wp-content/uploads/2023/12/Group-4-1.png",
        "w": 68, "d": 16, "h": 23, "weight": 90
    })

# Deep Fill Logic (from V14)
