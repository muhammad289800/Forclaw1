...
output_path = 'Wayfair_TV_Stands_FINAL_V17_HyperPrecision.xlsx'
...
if "Tools Needed" not in VALID_VALUES: VALID_VALUES["Tools Needed"] = ["Screwdriver", "Wrench", "No Tools Needed"]
...
for i, p in enumerate(products_data[:15]):
    ...
    mapping = {
        ...
        "Lead Time": VALID_VALUES["Lead Time"][1] if VALID_VALUES["Lead Time"] else 2, # Setting to 1 or 2 days, assuming 0 is problematic
...
wb.save(output_path)
print(f"Final V17 saved to {output_path}")
